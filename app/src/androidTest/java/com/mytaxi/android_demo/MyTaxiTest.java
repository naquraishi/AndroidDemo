...
//        SystemClock.sleep(1000);
    ...
    1. Search and select such that target driver appears at different index e.g. searching with "Sarah" would show up Sarah Scott as first name.
    2. Current tests activities code coverage has come about 82%; tests to be identified and added to increase the coverage.
    3. Phone wakeup and unlock logic can be added so that tests run fine irrespective of the phone's state.
